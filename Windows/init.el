...
;; findutils
(setq find-program "c:/p/findutils/bin/find.exe")
...
;;set media player
(setq eradio-player '("C:/Program Files/VideoLAN/VLC/vlc.exe" "--no-video" "-I" "rc"))
...
;;set channels
(setq eradio-channels '(("Chillsynth FM" . "https://nightride.fm/stations?station=chillsynth")
